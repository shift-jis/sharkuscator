...
class ResolvingDumper(
    ...
    private val eventContext: ObfuscationContext,
    ...
    override fun dump(outputJarFile: File) {
        ...
        JarOutputStream(FileOutputStream(outputJarFile)).use { outputStream ->
            ...
            for (classNode in jarContents.classContents.filter { !it.isAutoGenerated() }) {
    ...
    override fun dumpClass(outputStream: JarOutputStream, name: String, classNode: ClassNode): Int {
        val classDumpEvent = AssemblerEvents.ClassDumpEvent(eventContext, classNode)
        ...
        try {
            ...
            val classWriteEvent = AssemblerEvents.ClassWriteEvent(eventContext, classNode, classWriter.toByteArray())
    ...
    override fun dumpResource(outputStream: JarOutputStream, name: String, bytes: ByteArray): Int {
        ...
        val resourceWriteEvent = AssemblerEvents.ResourceWriteEvent(eventContext, name, bytes)
