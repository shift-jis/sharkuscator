    ...
    override fun traverseHierarchy(classNode: ClassNode) {
        if (visitHierarchies.add(classNode.name)) {
            if (classNode.node.superName != null) {
                ...
                if (classNode.name.contains("net/") || classNode.name.contains("cc/") || resolvedSuperNode.name.contains("cc/")) {
                    println("${classNode.getQualifiedName()} extends ${resolvedSuperNode.getQualifiedName()} autogenerated: ${resolvedSuperNode.isAutoGenerated()} ")
                }
